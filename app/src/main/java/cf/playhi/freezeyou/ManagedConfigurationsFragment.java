...
import cf.playhi.freezeyou.RestrictionManagerCompat;
import cf.playhi.freezeyou.Util;
import cf.playhi.freezeyou.KeyValuePairDialogFragment;
...
public class ManagedConfigurationsFragment extends ManageAppFragment
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle(R.string.managed_configurations);
    }
